 ...
 * @property {string} COMMIT_PROMPT - The prompt template for generating commit messages.
...
export enum ConfigKeys {
  ...
  COMMIT_PROMPT = 'AI_COMMIT_PROMPT',
  OPENAI_TEMPERATURE = 'OPENAI_TEMPERATURE',

  INCLUDE_REPO_CONTEXT = 'AI_COMMIT_INCLUDE_REPO_CONTEXT',
  EXCLUDE_LOCKFILES = 'AI_COMMIT_EXCLUDE_LOCKFILES',
